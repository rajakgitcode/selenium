...
public class RegistrationPage extends TestBase {
	...
	public void enterNewPassword(String str) {
		newPassword = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(newPassword));
		newPassword.clear();
		newPassword.sendKeys(str);
	}

	public void enterRetypePassword(String str) {
		retypePassword = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(retypePassword));
		retypePassword.clear();
		retypePassword.sendKeys(str);
	}

	public void clickOnPDAccept() {
		pdAccept = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.elementToBeClickable(pdAccept));
		pdAccept.click();
	}
	...
	public void verifyRegistrationTitle() {
		registrationTitle = new WebDriverWait(driver, Propertie.timeOutValue)
	...
	public void verifyTellUsAboutYourselfTitle() {
		tellUsAboutYourselfTitle = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(tellUsAboutYourselfTitle));
		softAssert.assertEquals(tellUsAboutYourselfTitle.getText(), "Tell Us About Yourself",
				"Tell Us About Yourself Title is NOT matching");
	}

	public void verifyPasswordTitle() {
		setPasswordTitle = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(setPasswordTitle));
	...
	public void verifyTermsAndConditionsTitle() {
		termsAndConditionsTitle = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(termsAndConditionsTitle));
		softAssert.assertEquals(termsAndConditionsTitle.getText(), "Terms and Conditions",
				"Terms and Conditions Title is NOT matching");
	}

	public void verifyFirstNameLabel() {
		firstNameLabel = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(firstNameLabel));
	...
	public void verifyLastNameLabel() {
		lastNameLabel = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(lastNameLabel));
		softAssert.assertEquals(lastNameLabel.getText(), "Last Name", "Last Name label is NOT matching");
	}

	public void verifyEmailLabel() {
		emailLabel = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(emailLabel));
		softAssert.assertEquals(emailLabel.getText(), "E-Mail", "E-Mail label is NOT matching");
	}

	public void verifyPasswordLabel() {
		passwordLabel = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(passwordLabel));
	...
	public void verifyRetypePasswordLabel() {
		retypeLabel = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(retypeLabel));
	...
	public void verifyTermsLabel1() {
		termsLabel1 = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(termsLabel1));
		softAssert.assertEquals(termsLabel1.getText(),
				"I have read the Privacy Statement and consent to this agreement.", "Terms label1 is NOT matching");
	}

	public void verifyTermsLabel2() {
		termsLabel2 = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(termsLabel2));
		softAssert.assertEquals(termsLabel2.getText(),
				"I have read and understood the Terms and Conditions of SAP Conversational AI.",
				"Terms label2 is NOT matching");
	}

	public void verifyRequiredLabel() {
		requiredLabel = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(requiredLabel));
	...
	public void verifyFirstNameError() {
		firstNameError = new WebDriverWait(driver, Propertie.timeOutValue)
	...
	public void verifyLastNameError() {
		lastNameError = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(lastNameError));
		softAssert.assertEquals(lastNameError.getText(), "Required field", "Last Name Error is NOT matching");
	}

	public void verifyEmailError() {
		emailError = new WebDriverWait(driver, Propertie.timeOutValue)
	...
	public void verifyPDAcceptError() {
		pdAcceptError = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(pdAcceptError));
		softAssert.assertEquals(pdAcceptError.getText(), "To accept the privacy statement, click the box above",
				"PD Accept Error is NOT matching");
	}

	public void verifyToutAcceptError() {
		toutAcceptError = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(toutAcceptError));
		softAssert.assertEquals(toutAcceptError.getText(), "To accept the terms of use, check the box",
				"Tout Accept Error is NOT matching");
	}

	public void verifyPasswordError() {
		passwordError = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(passwordError));
		softAssert.assertEquals(passwordError.getText(), "The password must comply with the requirements",
				"Password Error is NOT matching");
	}

	public void verifyReEnterPasswordError() {
		retypeError = new WebDriverWait(driver, Propertie.timeOutValue)
				.until(ExpectedConditions.visibilityOf(retypeError));
